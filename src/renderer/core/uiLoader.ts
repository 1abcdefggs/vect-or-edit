...
/**
 * Dynamically injects lazy HTML components into the DOM after the initial render.
 * This significantly improves the initial startup speed by reducing parsing and rendering time.
 */
export function injectLazyUIComponents(): void {
  ...
  // Dispatch an event so that other modules know the DOM nodes are now available for binding.
